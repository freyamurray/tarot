const cards = [
    ...
    // the devil reversed
    "The Devil reversed <br> <img class=card-img-r id=card onclick=revealMeaning() src=images/The_Devil.jpg> <p class=hidden id=blurb onclick=revealMeaning()>do not be ashamed of your innermost thoughts and feelings. <br><br> to depend on others you must first be able to depend on yourself. </p>", 
    // the tower
...
function pullOne() {
    ...
    document.getElementById("instructions").innerHTML="tap the card to reveal meaning";
}
